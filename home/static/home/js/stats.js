...
var myPieChart = new Chart(ctxP, {
    ...
    data: {
        labels: ["Correct", "Incorrect"],
        datasets: [{
            data: [by_subject["questionsCorrect"], by_subject["questionsWrong"]],
            backgroundColor: ['rgba(105, 0, 132, .2)', 'rgba(0, 137, 132, .2)'],
            borderColor: ['rgba(200, 99, 132, .7)', 'rgba(0, 10, 130, .7)']
        }]
    },
...
var myLineChart = new Chart(ctxL, {
    type: 'line',
    data: {
        labels: by_subject["improvementDates"],
        datasets: [{
            label: "% Accuracy at Date",
            data: by_subject["improvementNodes"],
            backgroundColor: ['rgba(105, 0, 132, .2)',
            ],
            borderColor: ['rgba(200, 99, 132, .7)',
            ],
...
var ctxP = document.getElementById("subjectDistroBarChart").getContext('2d');
var myPieChart = new Chart(ctxP, {
    type: 'bar',
    data: {
        labels: ['Math', 'Science', 'Reading'],
